...
from sqlalchemy import Column, String, Boolean, DateTime, Integer, ForeignKey, Text, Float
...
class AppDependency(Base):
    ...
    ecosystem = Column(String, nullable=False, index=True)  # npm, pypi, composer, cargo, go
    ...
    dependency_type = Column(String, nullable=False, default="production")  # production, development, optional, peer
    ...
    # File location
    manifest_file = Column(String, nullable=False)  # Path to package.json, requirements.txt, etc.
