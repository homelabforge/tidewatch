...
class DockerfileDependency(Base):
    ...
    # Dependency details
    dependency_type = Column(String, nullable=False, index=True)  # base_image, build_arg, runtime_image
    ...
    registry = Column(String, nullable=False, default="docker.io")  # docker.io, ghcr.io, etc.

    # Full image reference
    full_image = Column(String, nullable=False)  # e.g., "node:22-alpine", "python:3.14-slim"
