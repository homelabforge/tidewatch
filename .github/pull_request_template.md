...
- [ ] Tested with encryption disabled
- [ ] Tested in light mode
- [ ] Tested in dark mode
- [ ] Tested on desktop browser
- [ ] Tested on mobile browser
- [ ] Tested container update workflows
- [ ] Tested notification delivery

**Test Configuration:**
- TideWatch version/branch:
...
- `feat: add support for Kubernetes container updates`
- `fix: correct dependency ordering for restart sequences`
- `docs: update OIDC configuration guide`
- `refactor: optimize container status polling`
...
- [ ] I'm okay with my contribution being included in TideWatch
